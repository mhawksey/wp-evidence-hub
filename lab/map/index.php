...
<html lang="en">
    ...
    <head>
        ...
        <script type="text/javascript" src="http://analytics.wnstnsmth.net/piwik.js"></script>
    ...
    <body>
        ...
        <noscript>
            <!-- Piwik Image Tracker -->
            <img src="http://analytics.wnstnsmth.net/piwik.php?idsite=3&amp;rec=1" style="border:0" alt="" />
        </noscript>
        <!-- End Piwik -->
    </body>
</html>